...
import { showSettlementResultOnTripScreen } from '@roam/types/cashSettlementDisplay';
        ...
        <div className="mx-auto flex max-w-lg items-center gap-2 px-4 py-3 safe-x">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="truncate text-xs text-zinc-500">
              {showResult
                ? 'Your cash payment was recorded'
      ...
      <main className="mx-auto w-full max-w-lg flex-1 space-y-5 px-4 py-6 safe-x safe-b">
        ...
        {showResult ? (
          <button
            ...
            className="w-full rounded-2xl bg-zinc-900 py-3.5 text-base font-bold text-white touch-manipulation active:scale-[0.98]"
          >
            Continue
          </button>
        ) : (
          <p className="text-center text-sm leading-relaxed text-zinc-500">
            Your driver will enter the amount they received. You do not need to enter anything in
            the app.
          </p>
        )}
      </main>
