...
import {
  supabaseRidesAdmin as supabase,
  useForgotPassword,
  hasProductAdminRole,
...
export function RidesAdminLoginForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!hasProductAdminRole(data.session.user, 'rides')) {
    ...
    <div className="rides-admin-login">
      <aside className="rides-admin-login__brand" aria-hidden="true">
        <div className="rides-admin-login__brand-inner">
          ...
          <h1 className="rides-admin-login__title">Roam Rides</h1>
          <p className="rides-admin-login__subtitle">Admin Portal</p>
          <p className="rides-admin-login__tagline">
            Manage fare rules, surge pricing, and ride operations for the Roam Rides platform.
          </p>
        </div>
      </aside>
          ...
          <div className="rides-admin-login__card">
            <div className="rides-admin-login__card-header">
              ...
              <div>
                ...
                <p className="rides-admin-login__card-desc">Sign in to manage Roam Rides</p>
              </div>
            </div>
