      ...
      <div className="relative z-10 -mt-8 flex min-h-0 flex-1 flex-col overflow-y-auto rounded-t-[32px] bg-white px-5 pb-6 pt-8 shadow-[0_-10px_30px_rgba(0,0,0,0.06)] dark:bg-slate-900">
        ...
        <div className="mb-4 flex items-center gap-4">
          ...
          <button
            type="button"
            onClick={openChat}
            className="relative flex shrink-0 flex-col items-center gap-1 rounded-2xl bg-slate-100 px-3 py-2 transition-transform active:scale-95 dark:bg-slate-800"
