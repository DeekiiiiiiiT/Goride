/**
 * Driver settlement orchestration — driver-app wallet path.
...
export const settlementService = {
   ...
   */
  /**
   * @deprecated Stop-to-stop Charge Gap disabled (audit 2026-09-15). No-op.
   */
  async processGapDeduction(_bucket: OdometerBucket): Promise<FinancialTransaction | null> {
    console.log('[SettlementService] processGapDeduction skipped — stop-to-stop charges disabled');
    return null;
  }
};