  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-center justify-center bg-black/60 p-margin-mobile">
      <div className="flex max-h-[90dvh] w-full max-w-md flex-col overflow-hidden rounded-xl bg-surface shadow-xl">
        <header className="flex items-center justify-between border-b border-outline-variant p-inset-md">
        ...
        <div className="relative flex h-[min(350px,50dvh)] flex-col bg-surface-container-low">
          ...
          <div className="flex shrink-0 items-center gap-inset-sm border-t border-outline-variant/50 px-inset-md py-inset-sm">
        ...
        <footer className="flex justify-end gap-inset-sm border-t border-outline-variant bg-surface p-inset-md">
          <button
            type="button"
            onClick={handleCancel}
            className="rounded-lg px-inset-sm py-2 text-label-md font-semibold text-on-surface-variant transition-colors hover:bg-surface-container"
          >
            Cancel
          </button>
          <button
            ...
            className="rounded-lg bg-primary-container px-inset-sm py-2 text-label-md font-semibold text-on-primary shadow-sm transition-colors hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50"
          >
