...
const inputClass =
  'h-inset-xl w-full rounded-lg border border-outline-variant bg-transparent px-inset-sm text-body-lg text-on-surface placeholder:text-on-surface-variant/50 transition-colors partner-field';
    ...
    <div className="flex min-h-dvh flex-col overflow-x-hidden bg-surface text-on-surface antialiased">
      <header className="z-50 flex h-16 w-full items-center px-margin-mobile pb-2 pt-4">
        <button
          ...
          aria-label="Go back"
          onClick={onBack}
          className="flex h-inset-xl w-inset-xl items-center justify-center rounded-full text-on-surface-variant transition-colors hover:bg-surface-container-low"
        >
        ...
        <div className="w-inset-xl" />
      </header>

      <main className="mx-auto flex w-full max-w-[600px] flex-1 flex-col gap-inset-lg px-margin-mobile pb-inset-xl pt-inset-md">
        ...
        <form className="flex flex-col gap-inset-lg" onSubmit={(e) => e.preventDefault()}>
