/**
 * Courier Admin Service (dash-merchant copy) — API client for delivery edge admin routes.
 * Duplicated from dash-courier to keep the unified Rush Ops console self-contained.
 */
