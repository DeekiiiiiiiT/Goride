      ...
      case 'orders':
        return (
          <div className="text-slate-400">
            <h2 className="text-xl font-semibold text-white mb-4">Order Operations</h2>
            <p>Coming soon - Order management tools will be added here.</p>
          </div>
        );
      case 'dashboard':
      default:
        return (
          <div className="text-slate-400">
            ...
            <p>Overview metrics and analytics coming soon.</p>
          </div>
        );
    }
  };
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-amber-400 to-amber-600 flex items-center justify-center">
                <span className="text-xs font-bold text-slate-900">RD</span>
              </div>
              <div>
                <h1 className="font-semibold text-white text-sm">Roam Dash</h1>
