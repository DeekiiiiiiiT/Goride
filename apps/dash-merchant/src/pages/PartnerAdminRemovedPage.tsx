import { DASH_ADMIN_PRODUCTION_ORIGIN } from '../lib/ops-origin';

/** Shown when partner.roamrush.app/admin is hit — admin is on the main domain. */
export default function PartnerAdminRemovedPage() {
  const adminUrl = `${DASH_ADMIN_PRODUCTION_ORIGIN}/admin`;
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-slate-950 text-slate-100 px-6 text-center">
      ...
      <p className="mt-2 max-w-md text-sm text-slate-400">
        Rush Ops Console is not on the partner app. Use{' '}
        <a
          href={adminUrl}
