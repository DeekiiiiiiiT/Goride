  ...
  return (
    <div className="flex min-h-dvh flex-col items-center justify-center bg-surface text-on-surface">
      <main className="flex w-full max-w-[600px] flex-col items-center px-margin-mobile py-inset-xl text-center md:px-margin-tablet">
        <div className="mb-inset-lg w-full max-w-md">
        ...
        <div className="flex w-full max-w-sm flex-col gap-inset-md">
          <button
            ...
            className="flex h-inset-xl w-full items-center justify-center rounded-lg bg-primary-container text-label-md font-semibold text-on-primary-container shadow-sm transition-all duration-150 hover:shadow-md active:scale-[0.98]"
          >
            Get Started
          </button>
          <button
            type="button"
            onClick={onSignIn}
            className="p-inset-base text-label-md font-semibold text-secondary transition-colors duration-150 hover:text-secondary-container active:scale-[0.98]"
          >
