  ...
  return (
    <header className="fixed top-0 left-0 right-0 w-full bg-surface shadow-sm z-50 flex justify-between items-center px-[var(--spacing-edge)] min-h-14 pt-safe">
      <button
        ...
        onClick={onMenuClick}
        aria-label="Menu"
        className="flex items-center justify-center min-h-11 min-w-11 p-2 rounded-full hover:bg-surface-container-high transition-colors active:scale-95 text-primary"
      >
