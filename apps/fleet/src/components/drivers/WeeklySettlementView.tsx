...
import { DollarSign, Info, Eye } from "lucide-react";
...
// Smoke: week cards are cash-collection only — see cashWalletUi.smoke.test.ts

/** @deprecated Kept for any residual imports — Wallet no longer shows settlement. */
