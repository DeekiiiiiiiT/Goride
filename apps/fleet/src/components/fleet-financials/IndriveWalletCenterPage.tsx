  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div>
          <h1 className="hidden md:block text-2xl font-semibold text-slate-900 dark:text-slate-100">InDrive Wallet</h1>
          <p className="hidden md:block text-sm text-slate-500 dark:text-slate-400 mt-1 max-w-2xl">
