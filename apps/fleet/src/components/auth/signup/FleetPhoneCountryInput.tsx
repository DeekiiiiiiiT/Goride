...
import { Input, Label, Popover, PopoverContent, PopoverTrigger, ScrollArea } from '@roam/ui';
import { ChevronDown } from 'lucide-react';
import { PHONE_COUNTRIES, flagEmoji, type PhoneCountry } from '../../../utils/phoneCountries';

export interface FleetPhoneCountryInputProps {
  label?: string;
...
export function FleetPhoneCountryInput({
  label = 'Mobile number',
  selectedCountry,
  onSelectCountry,
  onMarkManualCountry,
