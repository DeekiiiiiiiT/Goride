...
/** Remaining driver-owed amount after platform reimbursement and extra credits. */
...
/** True when filing/charging the full toll while a smaller shortfall remains. */
...
export type ClaimChargeGuardResult =
  | { ok: true; amount: number }
  | { ok: false; message: string; suggestedAmount: number };
