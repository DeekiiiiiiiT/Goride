...
export const VEHICLE_CATALOG_CSV_COLUMNS: CsvColumn<VehicleCatalogRecord>[] = [
    ...
    { key: "production_start_month", label: "production_start_month" },
    { key: "production_end_month", label: "production_end_month" },
    ...
    { key: "engine_code", label: "engine_code" },
    { key: "engine_type", label: "engine_type" },
