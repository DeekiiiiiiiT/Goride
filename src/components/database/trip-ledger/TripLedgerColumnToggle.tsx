  ...
  return (
    <div className="relative" ref={containerRef}>
      ...
      >
        ...
        Columns
        {!isDefault && (
          <span className="ml-0.5 px-1.5 py-0.5 text-xs rounded-full bg-emerald-100 dark:bg-emerald-900/50 text-emerald-700 dark:text-emerald-300">
            {activeCount}
          </span>
        )}
      </button>
                    ...
                    return (
                      ...
                      >
                        <input
                          ...
                          className="h-3.5 w-3.5 rounded border-slate-300 dark:border-slate-600 text-emerald-600 focus:ring-emerald-500 focus:ring-offset-0 cursor-pointer"
                        />
