    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center gap-4 px-4 py-2 bg-slate-50 border rounded-lg text-[11px] font-medium text-slate-500">
        <div className="flex items-center gap-1.5">
          ...
          <span>Verified: Odometer anchor confirmed</span>
        </div>
        <div className="flex items-center gap-1.5">
          <Zap className="w-3.5 h-3.5 text-blue-600" />
          <span>Auto-Generated: System settlement</span>
        </div>
        <div className="flex items-center gap-1.5">
          <AlertTriangle className="w-3.5 h-3.5 text-amber-600" />
          <span>Observing: Pending next anchor scan</span>
        </div>
        ...
        <div className="flex items-center gap-1.5">
          ...
          <span>Credit (Company Share)</span>
        </div>
      </div>
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-xs text-slate-500 truncate">
                          {isPendingGroup 
                            ...
                            : `${group.bucket!.tripsCount} trips • ${group.bucket!.unaccountedDistance > 0 ? `${group.bucket!.unaccountedDistance.toLocaleString()}km gap` : 'No gaps detected'}`
                          }
                        </span>
                      </div>
                    </TableCell>
