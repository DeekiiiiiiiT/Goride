...
import { Calendar as CalendarIcon, FileDown, Loader2, DollarSign, Droplets, TrendingUp } from "lucide-react";
...
export function ReportsPage() {
    ...
    const handleGenerate = async () => {
        ...
        try {
            const [allEntries, allVehicles] = await Promise.all([
            ...
            if (Array.isArray(allVehicles)) {
                 allVehicles.forEach((v: any) => vMap[v.id] = v.name);
            }
            setVehiclesMap(vMap);
