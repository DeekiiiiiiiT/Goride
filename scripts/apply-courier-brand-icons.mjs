...
const appDir = 'apps/dash-courier';
const master = join(appDir, 'public/images/brand/roam-courier-icon-master.png');
...
console.log('Courier icons + splash from official master');
