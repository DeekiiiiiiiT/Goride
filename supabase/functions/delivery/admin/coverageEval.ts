 ...
 * inZone = inside ≥1 include AND not inside any exclude (active markets only).
 */
...
export function evaluateCoverage(lat: number, lng: number, zones: CoverageZone[]): CoverageEvalResult {
