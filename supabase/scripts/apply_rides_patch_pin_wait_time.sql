-- Run in Supabase SQL editor if migration 20260601160000 was not applied via CLI.
-- Copy of supabase/migrations/20260601160000_rides_patch_pin_wait_time.sql
