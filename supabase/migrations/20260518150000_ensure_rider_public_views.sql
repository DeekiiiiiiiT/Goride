-- Idempotent: rider admin columns, stats view, and public PostgREST views for hosted
-- projects that use public.rides_* (fare rules) but have not applied 20260518140000 yet.
