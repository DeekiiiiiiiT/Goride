...
import { PeriodWeekDropdown } from '@roam/ui';
...
function ChipDropdown({
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div role="listbox" className="absolute left-0 top-full mt-1.5 w-44 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 shadow-lg z-50 py-1">
          {/* "All" option */}
          <button
            onClick={() => {
              onChange('');
