...
export const TOLL_LOG_CSV_COLUMNS: CsvColumn<TollLogEntry>[] = [
  { key: 'date', label: 'Date' },
  { key: 'time', label: 'Time', formatter: (v) => (v == null ? '' : String(v)) },
  { key: 'vehicleName', label: 'Vehicle' },
  { key: 'driverDisplayName', label: 'Driver' },
  { key: 'plazaName', label: 'Plaza', formatter: (v) => (v == null ? '' : String(v)) },
  { key: 'highway', label: 'Highway', formatter: (v) => (v == null ? '' : String(v)) },
  { key: 'direction', label: 'Direction', formatter: (v) => (v == null ? '' : String(v)) },
  ...
  { key: 'referenceNumber', label: 'Reference #', formatter: (v) => (v == null ? '' : String(v)) },
  { key: 'tollTagId', label: 'Tag ID', formatter: (v) => (v == null ? '' : String(v)) },
  { key: 'description', label: 'Description' },
  { key: 'isReconciled', label: 'Reconciled', formatter: (v) => (v ? 'Yes' : 'No') },
  { key: 'tripId', label: 'Trip ID', formatter: (v) => (v == null ? '' : String(v)) },
  { key: 'batchId', label: 'Batch ID', formatter: (v) => (v == null ? '' : String(v)) },
];