...
/** Keep in sync with apps/dash-courier/android/version.properties */
export const DASH_COURIER_ANDROID_BUILD = {
  versionName: '1.0.5',
  versionCode: 6,
} as const;

export const DASH_COURIER_PLAY_STORE_META: PlayStoreProductMeta = {
  productLabel: 'Roam Rush Courier',
  packageId: 'co.roamenterprise.courier',
  privacyPolicyUrl: ROAM_LEGAL.privacyPolicyUrl,
  supabaseRedirectUrl: 'co.roamenterprise.courier://login',
  reviewerEmail: 'deekiiiiiii+roam.courier.review@gmail.com',
  reviewerPassword: 'RoamPlay2026!Courier',
  reviewerSteps:
    'Open app → Sign in with email + password (not Google) → grant location → Go Online.',
  repoVersionName: DASH_COURIER_ANDROID_BUILD.versionName,
  repoVersionCode: DASH_COURIER_ANDROID_BUILD.versionCode,
  playConsoleUrl: 'https://play.google.com/console',
};

export const DASH_COURIER_PLAY_STORE_CATALOG: PlayStoreChecklistItemDef[] = [
  {
    id: 'privacy_policy',
