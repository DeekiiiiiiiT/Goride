...
export const DASH_COURIER_DATA_SAFETY_TEMPLATE_VERSION = '2026-08-dash-courier-v1';
export const DASH_CUSTOMER_DATA_SAFETY_TEMPLATE_VERSION = '2026-08-dash-customer-v1';
