...
type BusinessTypesPageProps = {
  onBusinessTypesChanged?: () => void;
};
...
export function BusinessTypesPage({ onBusinessTypesChanged }: BusinessTypesPageProps = {}) {
