 ...
 * attach to ANY trip (it fell outside every trip's time window).
 *
 * Fleet-canonical: undateable / nearby unexplained orphans are NOT automatic
 * personal expense — they surface as low-confidence for human confirmation.
 *
 * Pure + dependency-free (no date-fns) for Vitest and Deno.
 */
