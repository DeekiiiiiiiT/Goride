...
export const MODULE_SEAT_PERMISSION: Readonly<Record<string, EnterpriseSeatPermission>> = {
  ...
  warehouse_inbound: 'freight.mailbox.read',
  warehouse_receive: 'freight.mailbox.write',
  warehouse_partner_links: 'freight.mailbox.write',
  warehouse_storage_billing: 'freight.mailbox.read',
  warehouse_bins: 'freight.mailbox.write',
